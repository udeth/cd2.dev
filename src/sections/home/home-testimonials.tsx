...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    content: `Clean & Complete (Design & Code). Thansk Cd2dev team :)`,
    postedAt: 'April 19, 2023 23:15:30',
  },
  {
    ...createReview(4),
    category: 'Customer Support',
    content: `Thanks to Cd2dev for customer support with email. I solved the problem. And the code quality is good, too.`,
